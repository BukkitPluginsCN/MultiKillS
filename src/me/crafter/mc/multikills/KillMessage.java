...
public class KillMessage {
	...
	public static String getKillMessage(DeathInfo info){
		if (info.getReason().equals("thorns")){
			return (thorns.get(random.nextInt(thorns.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("pvp")){
			return (pvp.get(random.nextInt(pvp.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("pvparrow")){
			return (pvparrow.get(random.nextInt(pvparrow.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("fuzhu")){
			return (fuzhu.get(random.nextInt(fuzhu.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("tnt")){
			return (tnt.get(random.nextInt(tnt.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("cactus")){
			return (cactus.get(random.nextInt(cactus.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("water")){
			return (water.get(random.nextInt(water.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("creeper")){
			return (creeper.get(random.nextInt(creeper.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("fall")){
			return (fall.get(random.nextInt(fall.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("anvil")){
			return (anvil.get(random.nextInt(anvil.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("fire")){
			return (fire.get(random.nextInt(fire.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("lava")){
			return (lava.get(random.nextInt(lava.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("lightning")){
			return (lightning.get(random.nextInt(lightning.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("potion")){
			return (potion.get(random.nextInt(potion.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("snowman")){
			return (snowman.get(random.nextInt(snowman.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("poison")){
			return (poison.get(random.nextInt(poison.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("hunger")){
			return (hunger.get(random.nextInt(hunger.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("suffocation")){
			return (suffocation.get(random.nextInt(suffocation.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("kill")){
			return (kill.get(random.nextInt(kill.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("voids")){
			return (voids.get(random.nextInt(voids.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("withereffect")){
			return (withereffect.get(random.nextInt(withereffect.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("skeleton")){
			return (skeleton.get(random.nextInt(skeleton.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("witherskeleton")){
			return (witherskeleton.get(random.nextInt(witherskeleton.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("zombie")){
			return (zombie.get(random.nextInt(zombie.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("spider")){
			return (spider.get(random.nextInt(spider.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("cavespider")){
			return (cavespider.get(random.nextInt(cavespider.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("enderman")){
			return (enderman.get(random.nextInt(enderman.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("silverfish")){
			return (silverfish.get(random.nextInt(silverfish.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("magmacube")){
			return (magmacube.get(random.nextInt(magmacube.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("slime")){
			return (slime.get(random.nextInt(slime.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("pigzombie")){
			return (pigzombie.get(random.nextInt(pigzombie.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("irongolem")){
			return (irongolem.get(random.nextInt(irongolem.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("giant")){
			return (giant.get(random.nextInt(giant.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("wither")){
			return (wither.get(random.nextInt(wither.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("blaze")){
			return (blaze.get(random.nextInt(blaze.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("ghast")){
			return (ghast.get(random.nextInt(ghast.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else if (info.getReason().equals("dispenser")){
			return (dispenser.get(random.nextInt(dispenser.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon());
		}
		else {
			return (other.get(random.nextInt(other.size()))).replace("%d", info.getDier()).replace("%k", info.getKiller()).replace("%w", info.getWeapon())+"("+info.getReason()+")";
		}
	}
